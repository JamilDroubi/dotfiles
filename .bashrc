...
if [ "$color_prompt" = yes ]; then
	PS1='${debian_chroot:(debian_host)}\[\033[01;32m\]\u\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
else
...
##Run Burpsuite with a command
alias burp='/home/jamil/BurpSuiteCommunity/BurpSuiteCommunity &'
##Run Owasp-Zap with a command
alias zap='/usr/share/ZAP_2.9.0/zap.sh &'
##Run firefox lazy ass
alias fire='firefox &'
##Run Pipes
alias pipes2='/opt/Color-Scripts/color-scripts/pipes2'
alias pipes2s='/opt/Color-Scripts/color-scripts/pipes2-slim'
##Run xeyes
alias xeyes='xeyes &'
##Run st term
...
bash_prompt() {
	...
	local SEPARATOR_2=$SEPARATOR_FORMAT_2$SYMBOL

	local SEPARATOR_3=$SEPARATOR_FORMAT_3$SYMBOL
